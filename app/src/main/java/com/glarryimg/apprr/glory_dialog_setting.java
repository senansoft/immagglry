...
public class glory_dialog_setting extends Dialog {

    public glory_dialog_setting(Context context, int layout, int style) {
        this(context, WindowManager.LayoutParams.MATCH_PARENT,
                WindowManager.LayoutParams.WRAP_CONTENT, layout, style,
                Gravity.BOTTOM);
    }

    public glory_dialog_setting(Context context, int width, int height, int layout,
